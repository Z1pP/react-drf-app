...
urlpatterns = [
    ...
    path('v1/users/favorites/<int:pk>', views.UserFavoritesListView.as_view(), name='favorites-cars'),
    path('v1/users/<int:pk>', views.UserDetailView.as_view(), name='users-detail'),
    path('v1/users/update/<int:pk>', views.UserUpdateView.as_view(),name='user-update'),
    # JWT route
